...
namespace IntraNet.Migrations
{
    ...
    [Migration("20260109165000_AddAutorIdToProcesso")]
    partial class AddAutorIdToProcesso
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("IntraNet.Models.Avisos", b =>
                {
            ...
            modelBuilder.Entity("IntraNet.Models.ChatMensagem", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("IntraNet.Models.Processo", b =>
                {
            ...
            modelBuilder.Entity("IntraNet.Models.Avisos", b =>
                {
                    b.HasOne("IntraNet.Models.ApplicationUser", "Autor")
                        .WithMany()
